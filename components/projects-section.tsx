...
const projects = [
  ...
  },
  {
    ...
    description: "Aplikasi manajemen proyek dengan fitur kolaborasi tim, tracking progress, dan reporting yang detail.",
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
            >
              <Card className="glass-card glow-purple-hover h-full border-border/50 transition-all duration-300 overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.technologies.map((tech) => (
                      <Badge key={tech} variant="secondary" className="glass-card text-xs">
                        {tech}
                      </Badge>
                    ))}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <Button size="sm" className="flex-1 glass glow-purple-hover bg-primary hover:bg-primary/90">
